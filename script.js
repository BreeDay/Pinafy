...
const navlnks = document.querySelector(".nav_links")


toggleButton.addEventListener('click', () =>{
  navc.classList.remove("nav");
  navc.classList.add("noodle");
  toggleButton.classList.add("hidden");
  exit.classList.remove("hidden");
  navlnks.classList.remove("hidden")
})

exit.addEventListener('click', () =>{
  toggleButton.classList.remove("hidden");
  exit.classList.add("hidden");
  navc.classList.add("nav");
  navc.classList.remove("noodle");
  navlnks.classList.add("hidden");
})

navlnks.addEventListener("click", () =>{
  toggleButton.classList.remove("hidden");
  exit.classList.add("hidden");
  navc.classList.add("nav");
  navc.classList.remove("noodle");
...
tabContainer.addEventListener('click', function (e) {
  ...
  tabs.forEach(t => t.classList.remove('benefits__tab--active'));
  tabContent.forEach(c => c.classList.remove('benefits__content--active'));
...
imgTargets.forEach(img => imgObsrver.observe(img));
